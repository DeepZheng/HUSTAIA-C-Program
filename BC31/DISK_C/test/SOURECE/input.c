...
/*
void input_notpassword(char *n_password,int x,int y,int num,int color)
{
    int k=0,i=0;
    char t;
    Line(x+10,y+6,x+10,y+40,color);
    while(bioskey(1))
    {
        k=bioskey(0);
    }
        ...
        if(i<num)
        {
            if(t!='\n'&&t!='\r'&&t!=' '&&t!=033)
            {
                if(t!='\b')
                {
                    n_password[i]=t;
                    n_password[i+1]='\0';
                    Bar(x+8+i*18,y+3,x+12+i*18,y+42,color);
                    Put_Asc16(x+8+i*18,y+3,t,color);
                    i++;
                    Line(x+12+i*18,y+3,x+12+i*18,y+42,color);
                }
                else if(t=='\b'&&i>0)
                {
                    Bar(x+8+i*18,y+3,x+12+i*18,y+42,color);
                    Bar(x-12+i*18,y+3,x-12+i*18,y+42,color);
                    Line(x-12+i*18,y+3,x-12+i*18,y+42,color);
                    i--;
                    n_password[i]='\0';
      //              n_password[i+1]='\0';
...
void input_password(char *password,int x,int y,int num,int color)
{
    int k=0,i=0;
    char t;
    Line(x+10,y+6,x+10,y+40,color);
